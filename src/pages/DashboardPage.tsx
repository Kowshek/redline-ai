...
const statusColors: Record<SessionStatus, 'default' | 'warning' | 'error' | 'success'> = {
  DRAFT: 'default',
  ATTACKING: 'error',
  DEFENDING: 'warning',
  COMPLETE: 'success',
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: 'background.default' }}>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        {/* Table */}
        <Paper elevation={0} sx={{ border: '1px solid', borderColor: 'grey.100', borderRadius: 2, overflow: 'hidden' }}>
